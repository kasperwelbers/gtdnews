...
This repository serves as an online appendix for [DOI forthcoming].
...
We have therefore created a helper package that contains the code in documented functions, and has the required packages as dependencies.
